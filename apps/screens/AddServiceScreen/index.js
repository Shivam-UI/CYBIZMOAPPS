...
import { MY_SERVICES_ADS_API } from '../../../configApi';
import Spinner from 'react-native-loading-spinner-overlay';
import axios from 'axios';

const ServiceAdManager = () => {
            ...
            <TouchableOpacity style={{
                ...
                <View style={{ flexDirection: 'column', borderBottomColor: '#aaaaaa', borderBottomWidth: 0 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', margin: 5 }}>
                        <Text style={{ fontWeight: 'bold', fontSize: 16 }}>Service Id : </Text>
                        <Text>{items.service_ID}</Text>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', margin: 5 }}>
    ...
    return (
        <SafeAreaView style={{ backgroundColor: '#f5f5f5', flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row', height: 55, alignItems: 'center', backgroundColor: '#00CCff' }}>
                ...
                <View style={{ flex: 1 }}>
                    <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 15, color: '#FFFFFF' }}>{"Service Ads Manager"}</Text>
                </View>
                <TouchableOpacity >
...
export default ServiceAdManager;