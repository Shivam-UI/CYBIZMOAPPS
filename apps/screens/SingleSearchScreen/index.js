        ...
        <SafeAreaView style={{ backgroundColor: '#f5f5f5', flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row', height: 55, alignItems: 'center', backgroundColor: '#00CCff' }}>
                <TouchableOpacity style={{ marginLeft: 10 }} onPress={() => navigation.goBack()}>
                    <Image source={require('../../../assets/images/back_icon.png')} style={{ width: 25, height: 25, marginRight: 10, resizeMode: 'contain', tintColor: '#FFFFFF' }} />
                </TouchableOpacity>
                <View style={{ flex: 1 }}>
                    <TextInput style={{ textAlign: 'left', fontWeight: 'bold', fontSize: 15, color: '#FFFFFF', borderColor: '#ffffff', borderWidth: 1, marginRight: 15, height: 43, padding: 5, backgroundColor: '#ffffff', borderRadius: 4 }}
...
export default SearchSingleScreen;