...
import { MY_JOBS_ADS_API } from '../../../configApi';
        ...
        return (
            <TouchableOpacity style={{
                ...
                <View style={{ flexDirection: 'column', borderBottomColor: '#aaaaaa', borderBottomWidth: 0 }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', margin: 5 }}>
                        <Text style={{ fontWeight: 'bold', fontSize: 16 }}>Job Type : </Text>
                        <Text style={{ fontWeight: 'bold' }}>{items.job_type}</Text>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', margin: 5 }}>
                        <Text style={{ fontWeight: 'bold', fontSize: 16 }}>Expiry Date : </Text>
                        <Text style={{ fontWeight: 'bold' }}>{items.featured_expiry_date === '' ? 'Not Promoted' : items.featured_expiry_date}</Text>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                        <View style={{ flex: 1, marginRight: 5 }}>
                            <TouchableOpacity style={{ padding: 15, alignSelf: 'center', backgroundColor: items.status === '1' ? 'green' : '#aaa', width: '100%', borderRadius: 5 }}>
                                <Text style={{ alignSelf: 'center', color: items.status === '1' ? 'white' : '#000', fontWeight: 'bold' }}>Active</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{ flex: 1 }}>
                            <TouchableOpacity style={{ padding: 15, alignSelf: 'center', backgroundColor: '#aaa', width: '100%', borderRadius: 5 }}>
                                <Text style={{ alignSelf: 'center', fontWeight: 'bold' }}>{items.status === '1' ? 'Live' : 'Draft'}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
    ...
    return (
        <SafeAreaView style={{ backgroundColor: '#f5f5f5', flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row', height: 55, alignItems: 'center', backgroundColor: '#00CCff' }}>
                ...
                <View style={{ flex: 1 }}>
                    <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 15, color: '#FFFFFF' }}>{"Job Ads Manager"}</Text>
                </View>
                <TouchableOpacity >
