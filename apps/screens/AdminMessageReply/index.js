            ...
            <ScrollView>
                <View>
                    <View style={{ padding: 20, marginTop: 10 }}>
                        ...
                        <TouchableOpacity style={{ padding: 20, backgroundColor: '#00ccff' }}>
                ...
                <View style={{ padding: 10 }}>
                    <Text style={{ fontWeight: 'bold', fontSize: 16 }}>Recent Message</Text>
                </View>
                <View>
                    <FlatList
                        style={{}}
...
export default AdminMessageReply;