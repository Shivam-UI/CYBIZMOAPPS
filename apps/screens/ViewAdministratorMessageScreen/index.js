...
import { MY_MESSAGE_LIST_ADMIN_API } from '../../../configApi';
import axios from 'axios';
 
const ViewAdministratorMessage = () => {
        ...
        return (
            <TouchableOpacity style={{ flexDirection: 'row', backgroundColor: '#FFFFFF', borderBottomWidth: 1, borderColor: '#AAA', padding: 10, alignItems: 'center' }} >
                <View style={{ backgroundColor: '#ffffff', flex: 1, padding: 15 }}>
                    <Text style={styles.title} >x Reagarding To:  {items.regarding_to}</Text>
...
export default ViewAdministratorMessage;